...
def eval(t):
    evaluation = 0
    evaluation += l7[
        1000000 * t[0][0] + 100000 * t[0][1] + 10000 * t[0][2] + 1000 * t[0][3] + 100 * t[0][4] + 10 * t[0][5] + t[0][
            6]]
    evaluation += l7[
        1000000 * t[1][0] + 100000 * t[1][1] + 10000 * t[1][2] + 1000 * t[1][3] + 100 * t[1][4] + 10 * t[1][5] + t[1][
            6]]
    evaluation += l7[
        1000000 * t[2][0] + 100000 * t[2][1] + 10000 * t[2][2] + 1000 * t[2][3] + 100 * t[2][4] + 10 * t[2][5] + t[2][
            6]]
    evaluation += l7[
        1000000 * t[3][0] + 100000 * t[3][1] + 10000 * t[3][2] + 1000 * t[3][3] + 100 * t[3][4] + 10 * t[3][5] + t[3][
            6]]
    evaluation += l7[
        1000000 * t[4][0] + 100000 * t[4][1] + 10000 * t[4][2] + 1000 * t[4][3] + 100 * t[4][4] + 10 * t[4][5] + t[4][
            6]]
    evaluation += l7[
        1000000 * t[5][0] + 100000 * t[5][1] + 10000 * t[5][2] + 1000 * t[5][3] + 100 * t[5][4] + 10 * t[5][5] + t[5][
            6]]
